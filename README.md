...
> **머신러닝 기반 SDN 네트워크 공격 방어 시스템**  
> Software Defined Networking 환경에서 실시간 위협 탐지 및 자동화된 보안 대응을 제공하는 지능형 보안 솔루션
...
현대 네트워크 환경에서 SDN의 중앙집중형 제어 구조는 새로운 보안 취약점을 만들어냅니다. 본 프로젝트는 **머신러닝 알고리즘**을 활용하여 SDN 네트워크에서 발생하는 다양한 공격을 실시간으로 탐지하고 자동으로 대응하는 지능형 보안 시스템을 구현합니다.
